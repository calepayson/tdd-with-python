...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Edith has heeard about a cool new online to-do app. She goes to check 
        # out its homepage
        ...
        # She types "Buy peacock feathers" intoo a text box (Edith's hobby is tying fly
        # fishing lures)
        ...
        # site has generateed a uniquee URL for her -- there is some explanatory text
        # to that effect
